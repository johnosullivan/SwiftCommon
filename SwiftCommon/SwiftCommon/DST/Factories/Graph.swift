...
public class SwiftGraph {
    ...
    func reversePath(head: PathDS!, source: Vertex) -> PathDS! {
    ...
    func processDijkstra(source: Vertex, destination: Vertex) -> PathDS? {
        
        
        var frontier: Array<PathDS> = Array<PathDS>()
        var finalPaths: Array<PathDS> = Array<PathDS>()
        
        
        //use source edges to create the frontier
        for e in source.neighbors {
            
            let newPath: PathDS = PathDS()
        ...
        while frontier.count != 0 {
            ...
            for x in 0..<frontier.count {
                ...
                let itemPath: PathDS = frontier[x]
        ...
        var shortestPath: PathDS! = PathDS()
    ...
    func processDijkstraWithHeap(source: Vertex, destination: Vertex) -> PathDS! {
